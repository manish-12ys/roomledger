...
class AnalyticsRepository {
  ...
  Future<SpendingBreakdown> getSpendingBreakdown({
    ...
    final personalTotal = (personalResults.first['total'] as num?)?.toDouble() ?? 0.0;
  ...
  Future<AnalyticsReport> getAnalyticsReport({
    ...
    final trend = await getSpendingTrend(startDate: startDate, endDate: endDate);
    final breakdown = await getSpendingBreakdown(startDate: startDate, endDate: endDate);
    final categoryBreakdown = await getCategoryBreakdown(startDate: startDate, endDate: endDate);
    final friendComparison = await getFriendDebtComparison(startDate: startDate, endDate: endDate);
